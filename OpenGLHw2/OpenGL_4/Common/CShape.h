...
// #ifdef LIGHTING_WITHGPU
	...
	point4  _vLightInView2;
	point4  _vLightInView3;
	point4  _vLightInView4;

	GLuint  _uiLightInView;	 // 光源在 shader 的位置
	GLuint  _uiLightInView2;
	GLuint  _uiLightInView3;
	GLuint  _uiLightInView4;
	...
	color4 _AmbientProduct2;
	color4 _AmbientProduct3;
	color4 _AmbientProduct4;

	color4 _DiffuseProduct;
	color4 _DiffuseProduct2;
	color4 _DiffuseProduct3;
	color4 _DiffuseProduct4;

	color4 _SpecularProduct;
	color4 _SpecularProduct2;
	color4 _SpecularProduct3;
	color4 _SpecularProduct4;
...
//#endif
	...
	//for ui
	//void		createBufferObjectUI();
	//void		drawingSetShaderUI();
...
public:
	...
	//void setShaderUI(GLuint uiShaderHandle = MAX_UNSIGNED_INT);
	//void setShaderUI(mat4& mxModelView, mat4& mxProjection, GLuint uiShaderHandle);
