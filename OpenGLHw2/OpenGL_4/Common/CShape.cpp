...
//void CShape::createBufferObjectUI()
//{
//	glGenVertexArrays(1, &_uiVao);
//	glBindVertexArray(_uiVao);
//
...
void CShape::setShader(GLuint uiShaderHandle)
{
	...
	if (_iMode == ShadingMode::GOURAUD_SHADING_GPU || _iMode == ShadingMode::PHONG_SHADING) {
		...
		_uiLightInView2 = glGetUniformLocation(_uiProgram, "LightInView2");
		glUniform4fv(_uiLightInView2, 1, _vLightInView2);
		_uiLightInView3 = glGetUniformLocation(_uiProgram, "LightInView3");
		glUniform4fv(_uiLightInView, 1, _vLightInView);
		_uiLightInView4 = glGetUniformLocation(_uiProgram, "LightInView4");
		glUniform4fv(_uiLightInView, 1, _vLightInView);


		_uiAmbient = glGetUniformLocation(_uiProgram, "AmbientProduct");
		glUniform4fv(_uiAmbient, 1, _AmbientProduct);
		_uiAmbient2 = glGetUniformLocation(_uiProgram, "AmbientProduct2");
		glUniform4fv(_uiAmbient2, 1, _AmbientProduct2);
		_uiAmbient3 = glGetUniformLocation(_uiProgram, "AmbientProduct3");
		glUniform4fv(_uiAmbient3, 1, _AmbientProduct3);
		_uiAmbient4 = glGetUniformLocation(_uiProgram, "AmbientProduct4");
		glUniform4fv(_uiAmbient4, 1, _AmbientProduct4);

		_uiDiffuse = glGetUniformLocation(_uiProgram, "DiffuseProduct");
		glUniform4fv(_uiDiffuse, 1, _DiffuseProduct);
		_uiDiffuse2 = glGetUniformLocation(_uiProgram, "DiffuseProduct2");
		glUniform4fv(_uiDiffuse2, 1, _DiffuseProduct2);
		_uiDiffuse3 = glGetUniformLocation(_uiProgram, "DiffuseProduct3");
		glUniform4fv(_uiDiffuse3, 1, _DiffuseProduct3);
		_uiDiffuse4 = glGetUniformLocation(_uiProgram, "DiffuseProduct4");
		glUniform4fv(_uiDiffuse4, 1, _DiffuseProduct4);

		_uiSpecular = glGetUniformLocation(_uiProgram, "SpecularProduct");
		glUniform4fv(_uiSpecular, 1, _SpecularProduct);
		_uiSpecular2 = glGetUniformLocation(_uiProgram, "SpecularProduct2");
		glUniform4fv(_uiSpecular2, 1, _SpecularProduct2);
		_uiSpecular3 = glGetUniformLocation(_uiProgram, "SpecularProduct3");
		glUniform4fv(_uiSpecular3, 1, _SpecularProduct3);
		_uiSpecular4 = glGetUniformLocation(_uiProgram, "SpecularProduct4");
		glUniform4fv(_uiSpecular4, 1, _SpecularProduct4);
...
//void CShape::setShaderUI(GLuint uiShaderHandle)
//{
//	//createBufferObjectUI();
//	glBindVertexArray(_uiVao);
//	glBindBuffer(GL_ARRAY_BUFFER, _uiBuffer);
//
//	// Load shaders and use the resulting shader program
...
//}
//void CShape::setShaderUI(mat4& mxModelView, mat4& mxProjection, GLuint uiShaderHandle)
//{
//	glBindVertexArray(_uiVao);
//	glBindBuffer(GL_ARRAY_BUFFER, _uiBuffer);
//
...
// 將資訊更新到 Shader 中
	if (_iMode == ShadingMode::GOURAUD_SHADING_GPU || _iMode == ShadingMode::PHONG_SHADING) {
		glUniform4fv(_uiLightInView, 1, _vLightInView);
		glUniform4fv(_uiLightInView2, 1, _vLightInView2);
		glUniform4fv(_uiLightInView3, 1, _vLightInView3);
		glUniform4fv(_uiLightInView4, 1, _vLightInView4);
